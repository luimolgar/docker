...
<?php
    ...
    $texto = 'Búsqueda sin resultados';
        ...
        $consulta = mysqli_query($conexion, "SELECT nombreuser, img, tipo, date_format(fecha_docu,'%d/%m/%Y') as fecha2
        ...
        if (mysqli_num_rows($consulta) > 0){
            ...
            echo "<table class='table table-striped' style='background-color: white'>";
                echo "<tr><th>Subido por:</th><th>Fecha de nómina/contrato:</th><th>Tipo:</th>";
